...
- Progress events, `get_progress_summary`, `update_learner_signal`, branch target metadata, alternate prompt variants, and full MCP resources are not implemented yet.
...
- Latest known local verification: `84` tests passed with `93.53%` coverage.
