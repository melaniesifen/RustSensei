...
- Full MCP resources are not implemented yet.
...
1. Add MCP resources for progress summary and curriculum concepts.
2. Resolve MCP SDK integration and test tool schemas/calls.
...
- Latest known local verification: `111` tests passed with `94.05%` coverage.
